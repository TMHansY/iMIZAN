...
export default function Coder() {
  ...
  const { cheatingLog, updateCheatingLog, incrementViolation } = useCheatingLog();
    ...
    const fetchCodingQuestion = async () => {
      try {
        ...
        if (response.data.success && response.data.data) {
          ...
          toast.error('No coding question found for this exam. Please contact your lecturer.');
        }
      } catch (error) {
    ...
    <Box sx={{ p: 3, height: '100vh', display: 'flex', flexDirection: 'column' }}>
      {isLoading ? (
        ...
        <Box sx={{ textAlign: 'center', p: 3 }}>
          No coding question found for this exam. Please contact your lecturer.
        </Box>
      ) : (
            ...
            <Box sx={{ width: '320px', height: '240px', flexShrink: 0 }}>
              <Paper sx={{ height: '100%', overflow: 'hidden' }}>
                <Webcam
                  ...
                  incrementViolation={incrementViolation}
                />
              </Paper>
            </Box>
          </Grid>
